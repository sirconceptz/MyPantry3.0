...
public class MigrationAppTo3Version {
    ...
    private static void setUpgragedIsDone(@NonNull Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        sharedPreferences
                .edit()
                .putBoolean(context.getString(R.string.preferences_key_upgraged_from_to_2_to_3_version), true)
                .apply();
    }
}